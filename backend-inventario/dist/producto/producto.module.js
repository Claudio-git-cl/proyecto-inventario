...
const prisma_service_1 = require("../prisma/prisma.service"); // Importa el servicio real
const producto_controller_1 = require("./producto.controller");
let ProductoModule = class ProductoModule {
};
ProductoModule = __decorate([
    (0, common_1.Module)({
        providers: [producto_service_1.ProductoService, prisma_service_1.PrismaService],
